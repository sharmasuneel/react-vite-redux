...
const sidebarItems: IconSidebarItem[] = [
  ...
  { icon: "requests", label: "Requests", id: "requests" },
  { icon: "workflows", label: "Workflows", id: "workflows" },
  { icon: "forms", label: "Forms", id: "forms" },
  { icon: "reports", label: "Reports", id: "reports" },
  { icon: "documents", label: "Documents", id: "documents" },
  { icon: "audit", label: "Audit", id: "audit" },
  { icon: "organization", label: "Organization", id: "org" },
];
...
const columns: DataColumn<RequestRow>[] = [
  ...
  { id: "department", header: "Department", accessorKey: "department", icon: <Icon name="building" className="w-3.5 h-3.5" /> },
  { id: "team", header: "Team", accessorKey: "team", icon: <Icon name="users" className="w-3.5 h-3.5" /> },
  { id: "created", header: "Created", accessorKey: "created", sortable: true, icon: <Icon name="calendar" className="w-3.5 h-3.5" /> },
  { id: "updated", header: "Updated", accessorKey: "updated", icon: <Icon name="calendar" className="w-3.5 h-3.5" /> },
];

const quickActions: QuickActionItem[] = [
  { id: "payment", icon: "payment", label: "New Payment", description: "Create a payment request", color: "bg-quick-action-payment" },
  { id: "request", icon: "new-request", label: "New Request", description: "Submit request form", color: "bg-quick-action-request" },
  { id: "ssi", icon: "ssi", label: "SSI Request", description: "Standing settlement", color: "bg-quick-action-ssi" },
  { id: "upload", icon: "upload", label: "Upload Document", description: "Add to filing", color: "bg-quick-action-upload" },
  { id: "customer", icon: "customer", label: "Add Customer", description: "New customer entry", color: "bg-quick-action-customer" },
];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      <IconSidebar
        ...
        logo={<Icon name="dashboard" className="w-6 h-6 text-primary" />}
      />
        ...
        <div className="flex flex-1 min-h-0">
          <main className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <StatCard icon="reports" value={118} label="Total Requests" trend={12} variant="blue" />
              <StatCard icon="requests" value={23} label="Pending Approvals" trend={5} variant="orange" />
              <StatCard icon="audit" value={87} label="Completed" trend={8} variant="green" />
              <StatCard icon="workflows" value={8} label="In Progress" trend={-3} variant="pink" />
            </div>
